      ...
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2 px-4">
          <div className="lg:ml-28">
            ...
            <p className="text-black mt-2">3 Aug 2022</p>

            <p className="text-black mt-6 lg:w-full text-xl">
              On 27th July 2022 Progress review meeting was held at Tides
              Business Incubation Office IIT Roorkee. The panel of experts
              reviewed the progress and provided their insights. The committee
              was satisfied with the progress and hence decided to disperse rest
