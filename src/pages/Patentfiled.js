        ...
        <div className="w-full lg:w-1/2 px-4">
          <div className="lg:ml-28">
            ...
            <p className="text-black mt-6 lg:w-full text-xl">
              The patent for the product Smart Dome was filed on 31st of January
              2023. The patent was filed by Suavy Technologies in Indian Patent
              Office. The application number of the patent is 2023106354. As of
              now, the patent is published.
            </p>
            <div>
