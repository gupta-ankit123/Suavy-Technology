      ...
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2 px-4">
          <div className="lg:ml-28">
            ...
            <p className="text-black mt-2">31 Dec 2022</p>

            <p className="text-black mt-6 lg:w-full text-xl">
              On 13th of December 2022, the project completion review at Tides
              IIT Roorkee was held. The panel of reviewers assess the project. A
              live demonstration of working prototype was conducted. The
              reviewers found all the objectives completed. This marked the
              completion of the project. This doesn't end our story as the
              prototype need to be converted into a marketable product and
              potential investors required.
            </p>
            <div>
